...
export class AnnouncementsController {
  ...
  @Post('/create')
  create(@Body(new ValidationPipe({transform:true, whitelist: true})) categories: CreateAnnouncementsDto){
  ...
  @Patch(':id/update')
  update(@Param('id') id: string, @Body() updateCategories: AnnouncementsEntity) {
